...
%   \begin{itemize}
%     \item тверді композитні електроліти;
%     \item полімерні композитні електроліти;
%     \item системи типу діелектрик--провідник.
%   \end{itemize}

  \textbf{Предмет дослідження:} ефективні електрична провідність та діелектрична проникність. 
%   \begin{itemize}
%     \item ефективна електрична провідність;
%     \item ефективна діелектрична проникність.
%   \end{itemize}
...
%2. Отримані рівняння для ефективної статичної провідності в достатній мірі точні для розглянутих модельних систем, що підтверджуються результатами порівняння їх розв`язків з даними симуляцій, отриманими методом Random Resistor Network.
...
%3. Отримані з кількісного опису експериментальних даних для квазістатичної провідності різних типів твердих композитних та полімерних композитних електролітів та провідності й проникності композитів типу діелектрик--провідник одночастинкові профілі провідності враховують вплив основних фізико-хімічних механізмів в системі та можуть бути використані для їх аналізу.
...
\begin{frame}{Висновки}
\footnotesize
%4. Положення порогу електричної перколяції в моделі визначається відносною товщиною оболонки, а значення ефективних критичних індексів залежать як від геометричних та електричних параметрів компонентів, так і способу обробки експериментальних даних, а тому демонструють широкий спектр значень.
