...
\begin{enumerate}[leftmargin=0.8cm, label={[}\arabic*$^\ast${]}]
	...
	\item Семенов~А.~К. Вплив неоднорідності міжфазного шару на перколяційну поведінку провідності систем типу ізолятор-провідник~/ А.~К.~Семенов~// ФАС. -- прийнято до друку. -- 2019.
\end{enumerate}
